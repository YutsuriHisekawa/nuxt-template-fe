...
const landing = reactive({
	api: {
		url: "/api/dynamic/__API_ENDPOINT__",
		searchFields: [__SEARCH_FIELDS__],
	...
	columns: [
__COLUMNS____HAS_SWITCH_COLUMN__
	],
})
...
<template>
	<div class="space-y-4 pt-5">
		<!-- Page Header -->
		<div class="px-1">
			<h1 class="text-xl sm:text-2xl font-bold tracking-tight">__READABLE_NAME__</h1>
			<p class="text-xs sm:text-sm text-muted-foreground">Kelola __READABLE_NAME_LOWER__ aplikasi</p>
		</div>
				...
				<div class="flex items-center gap-2">
					<form class="flex flex-1 items-center gap-2" @submit.prevent="onMobileSearch">
						<input
							v-model="searchInput"
							type="text"
							placeholder="Search __READABLE_NAME_LOWER__..."
				...
				<AlertDialogContent class="max-w-[90vw] sm:max-w-lg">
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Data "__DELETE_DESCRIPTION__" akan dihapus permanen.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
