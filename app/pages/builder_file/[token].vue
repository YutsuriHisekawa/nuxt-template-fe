...
import { isPrintableField as _isPrintableField, normalizePrintConfig, createDefaultPrintConfig, PRINT_PAPER_OPTIONS } from './builder/_usePrint';
      ...
      <Card v-if="landingConfig.length > 0">
        ...
        <TabsContent value="print" class="space-y-6 mt-4">
          <PrintConfigTab
            ...
            @update:printConfig="(v) => { printConfig = v }"
            @pushUndo="pushUndo"
          />
        </TabsContent>
      </Tabs>
