...
const landing = reactive({
	...
	columns: [
		...
		{ headerName: "Kode Coba", field: "kode_coba", minWidth: 140 },
		{ headerName: "Nama Coba", field: "nama_coba", minWidth: 140 },
		{ headerName: "Negara Vendor", field: "negara_supp_id", minWidth: 140 },
	],
})
				...
				<div v-else class="space-y-2">
					...
					>
						...
						<div class="grid grid-cols-1 gap-y-0.5 text-xs">
							...
							<div v-if="row.kode_coba"><span class="text-muted-foreground">Kode Coba:</span> <span class="font-medium">{{ row.kode_coba }}</span></div>
						</div>
