...
const API_BASE = "/api/fn/m_supplier/coba";
        ...
        <CardContent class="space-y-6">
          ...
          <div v-show="wizardStep === 2" class="grid grid-cols-1 gap-6">
            <FieldSelect
              ...
              @input="(v) => { values.negara_supp_id = v; values.kota_supp = '' }"
